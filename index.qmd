...
::: {.draft-note}
**Draft — not yet circulated.** Sessions gain a materials link once a presenter supplies
something; until then they simply don't have one. Two items need confirming before this goes
out: the Day 1 afternoon timings (see the note under that schedule) and the presenters marked
*tktk*.
:::
